...
int get_choice(char *str, int start, int end)
{                                           // 获取正确用户数字选择
  int choice;                               // 记录用户选择
...
int get_choice_show_screen(char *str_title, char *str, int start, int end)
{                                           // 获取正确用户数字选择(显示影厅特别版)
  int choice;                               // 记录用户选择
  char input[32];                           // 获取用户输入
  int num_temp = false, range_temp = false; // 错误提示
...
int judge_choice(char *input, int start, int end)
{ // 判断是否为正确数字
